  ...
  "items": [
    {
      ...
      "tag": "string",
      "lore_mechanic_choice": "string — required if type_id is KRISTALLSEJDARE/SHAMAN/LYÅDSKAPARE/ORAKEL; state which function_menu number and name was chosen. Examples: '4 — Dice control (lock/reroll)' or '7 — Ritual trigger on defined outcome' or '3 — Negotiation aid (emissary attitude)'. Omit for all other types.",
      ...
      "description": "string — max 280 characters. Physical object first, one distinctive detail. No lore summary.",
      "effect": "string — max 480 characters. Answer: trigger, actor, outcome, target, duration, frequency. MELEE/RANGED: must begin with weapon profile recipe.",
